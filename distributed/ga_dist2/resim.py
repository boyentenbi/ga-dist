            ...
            with open(node_log_file, 'a') as f:
                ...
                while True:
                    try:
                        ...
                        elites_str_mean = [(l["EliteGenome"], l["EvalMeanMax"]) for l in short_logs if l["EliteGenome"]]
                        ...
                        logger.info("Starting elite eval. Super_exp_id: {}, env_id: {}, global_seed:{}, node name: {}, assigned id: {}, node list: {}".format(
                            super_exp_id, env_id, str(exp["config"]["global_seed"]), node_name, node_id, node_list
                        ))
